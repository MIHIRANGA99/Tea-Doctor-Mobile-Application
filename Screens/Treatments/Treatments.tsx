    ...
    if (disease === "blister") {
      switch (true) {
        ...
        case percentage <= 40 && percentage > 20:
          return (
            <Text>
              බුබුලු අංගමාරය හානිය මේ දක්වා ළඟා වූ විට, වඩාත් ක්‍රියාශීලී පියවර
      ...
      switch (percentage) {
        ...
        case 5:
          return (
            <Text>
              මෙවැනි හානියකදි, ආසාදනයේ බරපතලකම පුළුල් හා තීරණාත්මක ප්‍රවේශයක් අවශ්‍ය වේ. පළමුවෙන්ම, ආසාදනය තවදුරටත් පැතිරීම වැළැක්වීම සඳහා දැඩි ලෙස බලපෑමට ලක් වූ සියලුම ගස් සහ දැව ඉවත් කිරීම හා ප්‍රතිස්ථාපනය කිරීම අත්‍යවශ්‍ය වේ. අනාගත ආසාදන අවදානම අවම කිරීම සඳහා කඳ ගුල්ලන් ගොදුරු විය හැකි අඩු ගස් විශේෂ සමඟ නැවත වගා කිරීම සලකා බලන්න. කෘමිනාශක යෙදීම හෝ භෞතික බාධක සවි කිරීම වැනි නව ගස් සඳහා වැළැක්වීමේ ක්‍රියාමාර්ග ක්‍රියාත්මක කිරීම, අලුතින් සිටුවන ලද ගස්වලට මෙම කඳ ගුල්ලන් ඇතුලුවීම වැලැක්වීම අත්‍යවශ්‍ය වේ. කඳ ගුල්ලන් උවදුර කළමනාකරණය කිරීමේදී පළපුරුදු හා පළිබෝධ පාලන විශේෂඥයින්ගෙන් වෘත්තීය සහය ලබා ගැනීම පුලුල් අවබෝධයක් සහ සහායක් ලබා ගත හැක. දැඩි ක්‍රියාමාර්ග ගැනීමෙන් පසුව පවා, ප්‍රදේශය අඛණ්ඩව අධීක්ෂණය කිරීම, ආසාදනයේ ඕනෑම වෙනසක් ක්ෂණිකව විසඳීමට වැදගත් වේ.
            </Text>
          );
        default:
          return <Text>ලොකු හානියක් නෙවෙයි</Text>;
  ...
  return (
    <View style={mainStyles.main}>
      ...
      >
        ...
        {/* හානි ප්‍රතිශතය: {Number(route.params.percentage)}% */}
